...
export default function EmployeesClient({ initialData }: EmployeesClientProps) {
  ...
  const [employeesData, setEmployeesData] =
    useState<EmployeesResponse>(initialData);
  ...
  const fetchEmployees = async () => {
    try {
      ...
      console.log(
        "✅ [Employees] Successfully fetched data:",
    ...
    <>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-[#191919] mb-1">
              Empleados
            </h2>
              ...
              {loading ? (
                ...
                <>
                  ...
                  {debouncedSearchQuery &&
                    ` (filtrado por "${debouncedSearchQuery}")`}
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-[#f8f8f8] border-b border-[#e6e6e6]">
              <tr>
                <th className="text-left px-6 py-3 text-sm font-medium text-[#78829d]">
                  Empleado
                </th>
                <th className="text-left px-6 py-3 text-sm font-medium text-[#78829d]">
                  ID Login
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="text-sm text-[#191919]">
                        {employee.carritoState}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm text-[#191919]">
                        {employee.logisticState}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-[#191919]">
                      {employee.incidencia}
                    </td>
                    <td className="px-6 py-4 text-sm text-[#78829d]">
                      {employee.petition}
                    </td>
                    <td className="px-6 py-4">
                    ...
                    {debouncedSearchQuery || hasActiveFilters ? (
                      <div className="space-y-2">
                        ...
                        <div className="text-sm">
                          ...
                          {debouncedSearchQuery}" o los filtros aplicados
                        </div>
                        <Button
                          variant="outline"
                          size="sm"
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    onClick={() => setShowFilterModal(false)}
                    className="text-[#78829d] hover:text-[#191919]"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label className="text-sm font-medium text-[#191919] mb-3 block">
                    Estado carrito
                  </label>
                  <div className="space-y-3">
                    {employeesData?.filters.availableCarritoStates.map(
                      (state) => (
                        <label
                          key={state}
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              handleFilterChange("carritoState", state)
                            }
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {employeesData?.filters.availableLogisticStates.map(
                      (state) => (
                        <label
                          key={state}
                          className="flex items-center space-x-3"
                        >
                          <input
                            ...
                            onChange={() =>
                              handleFilterChange("logisticState", state)
                            }
                            className="rounded border-[#e6e6e6] text-[#4370a8] focus:ring-[#4370a8]"
                          />
                          <span className="text-sm text-[#191919]">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {employeesData?.filters.availableIncidencias.map(
                      (state) => (
                        <label
                          key={state}
                          className="flex items-center space-x-3"
                        >
                          <input
                            ...
                            onChange={() =>
                              handleFilterChange("incidencia", state)
                            }
                            className="rounded border-[#e6e6e6] text-[#4370a8] focus:ring-[#4370a8]"
                          />
                          <span className="text-sm text-[#191919]">
